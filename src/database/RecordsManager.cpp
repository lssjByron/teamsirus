...
std::vector<BasicRecord*> RecordsManager::findRecordsInRange(int startYear, int endYear) {
    std::vector<BasicRecord*> returnList;
    for (auto &i: manager) {
        if(i.first >= startYear && i.first <= endYear)
            returnList.push_back(i.second);
    }
...
QString RecordsManager::createQStringForGrants(int startYear, int endYear, const std::vector<std::string> &sortFields, char filterStart, char filterEnd, std::map<int, std::vector<std::string>> map_filtered_data, std::map<int, std::vector<std::string>> map_filtered_category_data) {
    QString s = QString(analyze(startYear, endYear, sortFields, list(1, "Total Amount"), 0x1, sortFields.back(), filterStart, filterEnd, map_filtered_data, map_filtered_category_data).c_str());
...
QString RecordsManager::createQStringForPres(int startYear, int endYear, const std::vector<std::string> &sortFields, char filterStart, char filterEnd, std::map<int, std::vector<std::string>> map_filtered_data, std::map<int, std::vector<std::string>> map_filtered_category_data) {
...
QString RecordsManager::createQStringForPubs(int startYear, int endYear, const std::vector<std::string> &sortFields, char filterStart, char filterEnd, std::map<int, std::vector<std::string>> map_filtered_data, std::map<int, std::vector<std::string>> map_filtered_category_data) {
...
QString RecordsManager::createQStringForTeaching(int startYear, int endYear, const std::vector<std::string> &sortFields, char filterStart, char filterEnd, std::map<int, std::vector<std::string>> map_filtered_data, std::map<int, std::vector<std::string>> map_filtered_category_data) {
    return QString(analyze(startYear, endYear, sortFields, list(2, "Total Hours", "Number Of Trainees"), 0x0, sortFields.back(), filterStart, filterEnd, map_filtered_data, map_filtered_category_data).c_str());
...
std::vector<std::pair<std::string, int>> RecordsManager::getCountByName(int startYear, int endYear, char filterStart, char filterEnd) {
    ...
    // query the database
    std::string query = analyze(startYear, endYear, list(1, "Member Name"), list(0), 0, "Member Name", filterStart, filterEnd, map_filtered_data, map_filtered_category_data);
...
std::vector<std::pair<std::string, double>> RecordsManager::getTotalsTuple(int startYear, int endYear, const std::vector<std::string> &headers, const std::vector<std::string> &matchStrings, std::string accCol, char filterStart, char filterEnd) {
    ...
    std::map<int, std::vector<std::string>> map_filtered_category_data;
    // query the database
    std::string query = analyze(startYear, endYear, headers, list(1, accCol.c_str()), 0x0, headers.back(), filterStart, filterEnd, map_filtered_data, map_filtered_category_data);
...
std::string RecordsManager::analyze(int startYear, int endYear, const std::vector<std::string> &sortFields, std::string countCol, char filterStart, char filterEnd) {
    ...
    std::map<int, std::vector<std::string>> map_filtered_data;
    std::map<int, std::vector<std::string>> map_filtered_category_data;
    return analyze(startYear, endYear, sortFields, list(0), 0, countCol, filterStart, filterEnd, map_filtered_data, map_filtered_category_data);
...
std::string RecordsManager::analyze(int startYear, int endYear, const std::vector<std::string> &sortFields, const std::vector<std::string> &accs,
        ...
        int currencyMask, std::string countCol, char filterStart, char filterEnd, std::map<int, std::vector<std::string>> map_filtered_data, std::map<int, std::vector<std::string>> map_filtered_category_data) {
    std::string ret;
    int sum = 0;
    std::vector<BasicRecord*> records = findRecordsInRange(startYear, endYear);
    records = filterRecords(records, map_filtered_data);
    records = filterRecords(records, map_filtered_category_data);
...
std::vector<BasicRecord*> RecordsManager::filterRecords(std::vector<BasicRecord*> records,std::map<int, std::vector<std::string>> map_filtered_data){
   std::vector<BasicRecord*> returnList;
   if(!map_filtered_data.empty()){
       std::vector<std::string> temp_data = map_filtered_data.begin()->second;
       for(int counter = 0; counter < temp_data.size(); counter++){
           for(int i =0; i < records.size(); i++){
               BasicRecord* temp_rec = records[i];
               if(temp_rec->at(map_filtered_data.begin()->first) == temp_data[counter])
                   returnList.push_back(temp_rec);
           }
       }
   }
   else

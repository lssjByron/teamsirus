...
public:
    ...
    QString createQStringForGrants(int startYear, int endYear, const std::vector<std::string> &sortFields, char filterStart, char filterEnd, std::map<int, std::vector<std::string>> map_filtered_data, std::map<int, std::vector<std::string>> map_filtered_category_data);
    QList<QVariant> createHeadersListForGrants(std::string topLevel);
    QString createQStringForPres(int startYear, int endYear, const std::vector<std::string> &sortFields, char filterStart, char filterEnd, std::map<int, std::vector<std::string>> map_filtered_data, std::map<int, std::vector<std::string>> map_filtered_category_data);
    QList<QVariant> createHeadersListForPres(std::string topLevel);
    QString createQStringForPubs(int startYear, int endYear, const std::vector<std::string> &sortFields, char filterStart, char filterEnd, std::map<int, std::vector<std::string>> map_filtered_data, std::map<int, std::vector<std::string>> map_filtered_category_data);
    QList<QVariant> createHeadersListForPubs(std::string topLevel);
    QString createQStringForTeaching(int startYear, int endYear, const std::vector<std::string> &sortFields, char filterStart, char filterEnd, std::map<int, std::vector<std::string>> map_filtered_data, std::map<int, std::vector<std::string>> map_filtered_category_data);

    QList<QVariant> createHeadersListForTeaching(std::string topLevel);
    std::vector<BasicRecord*> filterRecords(std::vector<BasicRecord*> records,std::map<int, std::vector<std::string>> map_filtered_data);
